const nombreCliente = "Land Rover";

export const Constantes = {
    nombreCliente: "Land Rover",
    webAliado: "https://www.landrover.co/",
    ...
    modelos: [
       ...
       userpass: "bABhAG4AZABSAG8AdgBlAHIAOgBsADQAbgBkAHIAMAB2ADMAcgA=",
        tyc: {
